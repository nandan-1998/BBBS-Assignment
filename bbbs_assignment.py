...
packet_duration_1 = 581e-6 
packet_bandwidth_1 = 10e6  

# Design an FIR bandpass filter for packet 1
center_freq_1 = 20e6  # Center frequency: 20 MHz
lower_cutoff_1 = center_freq_1 - packet_bandwidth_1 / 2  
upper_cutoff_1 = center_freq_1 + packet_bandwidth_1 / 2  
normalized_lower_cutoff_1 = lower_cutoff_1 / nyquist_rate
normalized_upper_cutoff_1 = upper_cutoff_1 / nyquist_rate

# Ensure upper cutoff frequency is strictly less than 1 after normalization
...
# Applying the filter and extract the packet
filtered_data_1 = signal.lfilter(filter_coeffs_1, [1.0], data)
num_samples_1 = int(packet_duration_1 * sampling_rate)
start_idx_1 = 0  # Assuming the packet starts at the beginning of the data samples
...
packet_duration_2 = 5.08e-3  
packet_bandwidth_2 = 20e6  

# Design an FIR bandpass filter for packet 2
center_freq_2 = 30e6  # Center frequency: 30 MHz
lower_cutoff_2 = center_freq_2 - packet_bandwidth_2 / 2  
upper_cutoff_2 = center_freq_2 + packet_bandwidth_2 / 2 
...
# Assuming there are N packets present in the sample. we are taking N=10 here
N = 10  
packets_2 = []
for i in range(N):
...
#Save the extracted packets to files 
np.save('packet_1.npy', packet_1)
np.savez('packets_2.npz', *packets_2)

#  shapes of the extracted packets
